...
CATALOGS = {
    "es": {
        ...
        "tab.search": "Buscar",
        "menu.file": "Archivo",
        "menu.file.new_tab": "Nueva pestaña",
        "menu.file.close_tab": "Cerrar pestaña",
        ...
        "menu.search": "Buscar",
        "menu.search.focus": "Enfocar búsqueda",
        "menu.search.match_case": "Coincidir mayúsculas",
        "menu.search.regex": "Regex",
        "menu.search.match_path": "Coincidir ruta",
        "menu.search.whole_word": "Palabra completa",
        "menu.search.clear_history": "Borrar historial de búsqueda",
        "menu.search.filter": "Filtro",
        "menu.search.manage_filters": "Administrar filtros",
        "menu.search.tab_switcher": "Cambiar pestaña",
        ...
        "menu.tools.rebuild_index": "Reconstruir índice",
        ...
        "settings.content.roots": "Raíces:",
        "settings.content.extensions": "Extensiones:",
        "settings.content.cache_quota": "Cuota de caché:",
        "settings.content.max_file_size": "Tamaño máximo de archivo:",
        "settings.content.cache_group": "Caché de contenido",
        "settings.content.purge_all": "Purgar toda la caché",
        "settings.content.purge_root": "Purgar raíz...",
        "diagnostics.title": "Diagnósticos de QuickFind",
        "diagnostics.refresh": "Actualizar",
        "diagnostics.rebuild": "Reconstruir índice",
        "diagnostics.save_cache": "Guardar caché",
        ...
        "help.title": "Ayuda sin conexión de QuickFind",
        "help.search_syntax": "Sintaxis de búsqueda",
        "help.workflows": "Flujos de trabajo principales",
        "help.troubleshooting": "Solución de problemas",
        "help.intro": "Esta hoja de referencia está incluida con QuickFind y no requiere acceso a la red.",
