...
def build(onefile=False):
    ...
    hidden = [
        ...
        'core.localization', 'core.dep_audit', 'core.duplicate_review',
        'core.plugin_loader', 'core.portable', 'core.result_export',
        'core.network_shares', 'core.platform_engines',
        'core.content', 'core.content.adapters', 'core.content.indexer',
        'core.content.sandbox', 'core.content.refresh_queue',
        'core.worker_isolation', 'core.sqlite_compat',
        'core.runtime_info', 'core.support_bundle',
        'gui.main_window', 'gui.results_view', 'gui.settings_dialog',
        'gui.diagnostics_dialog', 'gui.query_chips',
        'gui.theme', 'gui.tray', 'gui.accessibility', 'gui.help_docs',
        'cli.es', 'server.http_server', 'server.acl', 'py7zr',
