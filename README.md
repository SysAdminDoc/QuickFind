...
![Version](https://img.shields.io/badge/Version-v0.8.25-blueviolet)
...
- **19 search modifiers**: `case:`, `path:`, `file:`, `folder:`, `wholeword:`, `ext:`, `size:`, `dm:`, `dc:`, `len:`, `attrib:`, `content:`, `parent:`, `dupe:`, `duplicate:`, `broken:`, `archive:`, `fuzzy:`, `regex:`
...
| Component | Supported | Tested in v0.8.25 |
|-----------|-----------|------------------|
