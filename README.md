...
![Version](https://img.shields.io/badge/Version-v0.8.24-blueviolet)
...
- **18 search modifiers**: `case:`, `path:`, `file:`, `folder:`, `wholeword:`, `ext:`, `size:`, `dm:`, `dc:`, `len:`, `attrib:`, `content:`, `parent:`, `dupe:`, `duplicate:`, `archive:`, `fuzzy:`, `regex:`
...
| Component | Supported | Tested in v0.8.24 |
|-----------|-----------|------------------|
